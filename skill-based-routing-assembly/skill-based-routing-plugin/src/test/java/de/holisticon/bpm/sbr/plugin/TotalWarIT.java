...
public class TotalWarIT {
  ...
  public void initProperties() throws Exception {
    ...
    Files.copy(new File(getClass().getClassLoader().getResource("total-war/user_requiredSkills.dmn").toURI()), temporaryFolder.newFile("total-war/user_requiredSkills.dmn"));
    Files.copy(new File(getClass().getClassLoader().getResource("total-war/user_requiredAuthorizations.dmn").toURI()), temporaryFolder.newFile("total-war/user_requiredAuthorizations.dmn"));
    Files.copy(new File(getClass().getClassLoader().getResource("total-war/user_candidateUserRouting.dmn").toURI()), temporaryFolder.newFile("total-war/user_candidateUserRouting.dmn"));
